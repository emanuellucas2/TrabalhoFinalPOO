...
public class Ibm implements Sensor {
    protected int id;
    ...
    public void getIbmValue(){
		
    	if(this.cicle % this.updateInterval == 0) {
			try {
				URLConnection openConnection = new URL("https://www.alphavantage.co/query?function=GLOBAL_QUOTE&symbol=IBM&apikey=TDGP7NIDB9MRTNG6").openConnection();
				...
				JSONObject dados = (JSONObject) json.get("Global Quote");
				
				this.value = Double.parseDouble((String)dados.get("02. open"));
